...
# binami sudo pip install pandas xlrd openpyxl sklearn tables xlsxwriter bottle
# pyhthonanywhere.com pip install --user pandas xlrd openpyxl sklearn tables xlsxwriter bottle
